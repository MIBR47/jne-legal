...
@section('content')
    <div class="flex flex-col gap-4 mx-36 my-4">
        ...
        <form class="mt-4" method="POST" enctype="multipart/form-data"
            action="{{ route('perizinan-baru-finish-post', $data->id) }}">
            @csrf
                ...
                <div class="block">
                    ...
                    <div class="flex-[4]">
                        <textarea id="message" rows="4" name="note"
                            ...
                            placeholder="">Permohonan pengajuan reklame telah selesai, Silahkan download file SKPD sebagai arsip apabila ada pemeriksaan dari instansi berwenang.</textarea>
                    </div>
                </div>
            </div>
