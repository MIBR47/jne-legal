...
@section('content')
    <div class="flex flex-col gap-4 mx-36 my-4">
        ...
        <form class="mt-4" method="POST" enctype="multipart/form-data"
            action="{{ route('perizinan-baru-update-post', $data->id) }}">
            @csrf
                ...
                <div class="block">
                    ...
                    <div class="flex-[4]">
                        <textarea id="message" rows="4" name="note"
                            ...
                            placeholder="">Silahkan mengambil SKPD tersebut ke Legal untuk segera langsung diproses pembayaran ke Cost Control</textarea>
                    </div>
                </div>
            </div>
