...
@section('content')
    ...
    <div class="flex flex-col gap-4 mx-36 my-4">
        ...
        <div class="tab">
            <div class="grid grid-cols-2 gap-16 mb-4">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="flex">
                        ...
                        <div class="flex-[4]">
                            <input type="text" id="text" value="{{ $data->other->department }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div class="flex flex-col gap-4">
                    <div class="flex">
                        <label for="text"
                            ...
                            Dokumen</label>
                        <div class="flex-[4]">
                            <input type="text" id="text" value="{{ $data->other->document_number }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div class="flex">
                        ...
                        <div class="flex flex-[4]">
                            ...
                            <input type="text" id="website-admin" value="{{ $data->other->total_loss }}"
            ...
            <div class="flex flex-col mb-4">
                ...
                <textarea id="message" rows="4" name="incident_chronology"
                    ...
                    placeholder="" readonly>{{ $data->other->incident_chronology }}</textarea>
            </div>
        ...
        <form class="mt-4" method="post" enctype="multipart/form-data"
            action="{{ route('cs-update-other-post', $data->id) }}">
            @csrf
            <div class="tab">
                <div class="flex flex-col gap-4 mb-4">
