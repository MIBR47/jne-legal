...
class LeaseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $name1 = time() . '-' . $request->file('file_director_disposition')->getClientOriginalName();
        $name2 = time() . '-' . $request->file('file_internal_memo')->getClientOriginalName();
        $name3 = time() . '-' . $request->file('file_id_card')->getClientOriginalName();
        $name4 = time() . '-' . $request->file('file_npwp')->getClientOriginalName();
        $name5 = time() . '-' . $request->file('file_kk')->getClientOriginalName();
        $name6 = time() . '-' . $request->file('file_mariagge_book')->getClientOriginalName();
        $name7 = time() . '-' . $request->file('file_director_id_card')->getClientOriginalName();
        $name8 = time() . '-' . $request->file('file_deed')->getClientOriginalName();
        $name9 = time() . '-' . $request->file('file_sk_menkumham')->getClientOriginalName();
        $name10 = time() . '-' . $request->file('file_business_permit')->getClientOriginalName();
        $name11 = time() . '-' . $request->file('file_nib')->getClientOriginalName();
        $name12 = time() . '-' . $request->file('file_npwp_company')->getClientOriginalName();
        $name13 = time() . '-' . $request->file('file_location_permit')->getClientOriginalName();
        $name14 = time() . '-' . $request->file('file_setificate')->getClientOriginalName();
        $name15 = time() . '-' . $request->file('file_imb')->getClientOriginalName();
        $name16 = time() . '-' . $request->file('file_sppt1')->getClientOriginalName();
        $name17 = time() . '-' . $request->file('file_sppt2')->getClientOriginalName();
        $name18 = time() . '-' . $request->file('file_sppt3')->getClientOriginalName();
        $name19 = time() . '-' . $request->file('file_procuration')->getClientOriginalName();
        $name20 = time() . '-' . $request->file('file_previous_agreement')->getClientOriginalName();
        $name21 = time() . '-' . $request->file('file_director_procuration')->getClientOriginalName();
